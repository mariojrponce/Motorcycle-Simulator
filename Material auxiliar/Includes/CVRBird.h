/***********************************************************************
*Nome: CVRBird.h
*Descrição: Cabeçalho da classe responsável pelo tracker
*Data: 18/01/07
*Local: LNCC
************************************************************************/
#ifndef _CVRBIRD_
...
//Estrutura que guarda os valores das posicoes
struct position
{
      double vet[4][3];
};
...
//Estrutura que guarda os valores das posicoes
union packPosition{
      struct position values;
      char msg[sizeof(struct position)];
};

//Estrutura que guarda os valores das posicoes e angulos
struct quaternion{
      double vet[4][4];
};

//Estrutura que guarda os valores das posicoes e angulos
union packQuaternion{
      struct quaternion values;
      char msg[sizeof(struct quaternion)];
};

//Estrutura que guarda os valores de angulos
struct position_angles
{
      double vet[4][6];
};

//Estrutura que guarda os valores de angulos
union packPosition_angles
{
      struct position_angles values;
      char msg[sizeof(struct position_angles)];
};

//Estrutura que guarda os valores de posicoes
...
//Estrutura que guarda os valores das posicoes
union packPosition_quaternion
{
      struct position_quaternion values;
      char msg[sizeof(struct position_quaternion)];
};
